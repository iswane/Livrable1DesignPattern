...
<body>
	...
	<div id="breadcrumb" class="section">
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-12">
					<h3 class="breadcrumb-header">Ajouter Produit</h3>
					...
					<div class="billing-details">
						<form method="post" action="addProduct" enctype="multipart/form-data">
							<div class="section-title">
								<h3 class="title">Ajouter une voiture</h3>
							</div>
							...
							<div class="form-group">
								<input class="form-control" type="number" name="puissance"
							...
							<div class="custom-file">
								<label class="custom-file-label" for="photo">Choisir une
									image </label> <input type="file" class="custom-file-input" id="photo"
									name="photo" required="required"><br>
							</div>

							<!-- Order notes -->
							<div class="form-group">
								<textarea class="form-control"
									placeholder="Description sommaire de la voiture"
									name="description"></textarea>
							</div>
							<!-- /Order notes -->
							<div class="form-group">
								<button class="primary-btn order-submit">Ajouter</button>
							</div>
						</form>
					</div>
					<!-- /Billing Details -->
